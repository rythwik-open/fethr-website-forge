...
import { MapPin, Smartphone, MousePointer, Search } from 'lucide-react';
    ...
    <section id="features" className="py-16 sm:py-24 bg-gray-50">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-xl text-gray-600">Our intelligent platform creates personalized websites that match your brand and location.</p>
        </div>
            ...
            <div className="grid md:grid-cols-2">
              <div className="p-8 md:p-12 flex flex-col justify-center">
                ...
                <ul className="space-y-2">
                  {['Smart template selection', 'Automatic content generation', 'Industry-specific features', 'Integrated contact forms'].map((item, index) => (
